...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BluuSite.many_inhabitants'
        db.add_column(u'bluusites_bluusite', 'many_inhabitants',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BluuSite.many_inhabitants'
        db.delete_column(u'bluusites_bluusite', 'many_inhabitants')
