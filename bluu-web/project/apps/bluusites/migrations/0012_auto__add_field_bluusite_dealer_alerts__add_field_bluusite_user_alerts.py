...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BluuSite.dealer_alerts'
        db.add_column(u'bluusites_bluusite', 'dealer_alerts',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'BluuSite.user_alerts'
        db.add_column(u'bluusites_bluusite', 'user_alerts',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BluuSite.dealer_alerts'
        db.delete_column(u'bluusites_bluusite', 'dealer_alerts')

        # Deleting field 'BluuSite.user_alerts'
        db.delete_column(u'bluusites_bluusite', 'user_alerts')
