...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BluuSiteAccess', fields ['site', 'user']
        db.create_unique(u'bluusites_bluusiteaccess', ['site_id', 'user_id'])

        # Adding unique constraint on 'BluuSiteAccess', fields ['site', 'email']
        db.create_unique(u'bluusites_bluusiteaccess', ['site_id', 'email'])


    def backwards(self, orm):
        # Removing unique constraint on 'BluuSiteAccess', fields ['site', 'email']
        db.delete_unique(u'bluusites_bluusiteaccess', ['site_id', 'email'])

        # Removing unique constraint on 'BluuSiteAccess', fields ['site', 'user']
        db.delete_unique(u'bluusites_bluusiteaccess', ['site_id', 'user_id'])
