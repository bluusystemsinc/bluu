...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BluuSite.last_seen'
        db.add_column(u'bluusites_bluusite', 'last_seen',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BluuSite.last_seen'
        db.delete_column(u'bluusites_bluusite', 'last_seen')
