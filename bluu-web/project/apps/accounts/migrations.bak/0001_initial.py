...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_bluuuser', (
            ...
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'company_bluuuser', null=True, to=orm['accounts.Company'])),
            ('contract', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'contract_bluuuser', null=True, to=orm['accounts.Contract'])),
        ))
    ...
    models = {
        u'accounts.bluuuser': {
            ...
            'contract': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'contract_bluuuser'", 'null': 'True', 'to': u"orm['accounts.Contract']"}),
