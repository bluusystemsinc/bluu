...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompanyAccess'
        db.create_table(u'companies_companyaccess', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'companies', ['CompanyAccess'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CompanyAccess'
        db.delete_table(u'companies_companyaccess')
