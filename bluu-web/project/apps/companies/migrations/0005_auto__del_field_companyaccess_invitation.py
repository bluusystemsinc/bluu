...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyAccess.invitation'
        db.delete_column(u'companies_companyaccess', 'invitation')


    def backwards(self, orm):
        # Adding field 'CompanyAccess.invitation'
        db.add_column(u'companies_companyaccess', 'invitation',
