...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.code'
        db.add_column(u'companies_company', 'code',
                self.gf('django.db.models.fields.CharField')(unique=True, null=True, blank=True, max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.code'
        db.delete_column(u'companies_company', 'code')
