...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.code'
        db.alter_column(u'companies_company', 'code', self.gf('django.db.models.fields.CharField')(default=1, unique=True, max_length=6))
        # Adding unique constraint on 'Company', fields ['code']
        db.create_unique(u'companies_company', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'Company', fields ['code']
        db.delete_unique(u'companies_company', ['code'])


        # Changing field 'Company.code'
        db.alter_column(u'companies_company', 'code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))
