...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CompanyAccess', fields ['company', 'user']
        db.create_unique(u'companies_companyaccess', ['company_id', 'user_id'])

        # Adding unique constraint on 'CompanyAccess', fields ['company', 'email']
        db.create_unique(u'companies_companyaccess', ['company_id', 'email'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompanyAccess', fields ['company', 'email']
        db.delete_unique(u'companies_companyaccess', ['company_id', 'email'])

        # Removing unique constraint on 'CompanyAccess', fields ['company', 'user']
        db.delete_unique(u'companies_companyaccess', ['company_id', 'user_id'])
