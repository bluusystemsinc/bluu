...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserAlertRoom'
        db.create_table(u'alerts_useralertroom', (
            ...
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bluusites.Room'])),
        ...
        db.send_create_signal(u'alerts', ['UserAlertRoom'])

        # Adding unique constraint on 'UserAlertRoom', fields ['user', 'room', 'alert']
        db.create_unique(u'alerts_useralertroom', ['user_id', 'room_id', 'alert_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserAlertRoom', fields ['user', 'room', 'alert']
        db.delete_unique(u'alerts_useralertroom', ['user_id', 'room_id', 'alert_id'])

        # Deleting model 'UserAlertRoom'
        db.delete_table(u'alerts_useralertroom')
