...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserAlertWeightConfig', fields ['bluusite', 'device_type', 'user', 'alert']
        db.delete_unique(u'alerts_useralertweightconfig', ['bluusite_id', 'device_type_id', 'user_id', 'alert_id'])

        # Deleting model 'UserAlertWeightConfig'
        db.delete_table(u'alerts_useralertweightconfig')

        # Adding model 'UserAlertScaleConfig'
        db.create_table(u'alerts_useralertscaleconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bluusite', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bluusites.BluuSite'])),
            ('device_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.DeviceType'])),
        ...
        db.send_create_signal(u'alerts', ['UserAlertScaleConfig'])

        # Adding unique constraint on 'UserAlertScaleConfig', fields ['bluusite', 'device_type', 'user', 'alert']
        db.create_unique(u'alerts_useralertscaleconfig', ['bluusite_id', 'device_type_id', 'user_id', 'alert_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserAlertScaleConfig', fields ['bluusite', 'device_type', 'user', 'alert']
        db.delete_unique(u'alerts_useralertscaleconfig', ['bluusite_id', 'device_type_id', 'user_id', 'alert_id'])

        # Adding model 'UserAlertWeightConfig'
        db.create_table(u'alerts_useralertweightconfig', (
            ('email_notification', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('bluusite', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bluusites.BluuSite'])),
            ('device_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.DeviceType'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.BluuUser'])),
        ...
        db.send_create_signal(u'alerts', ['UserAlertWeightConfig'])

        # Adding unique constraint on 'UserAlertWeightConfig', fields ['bluusite', 'device_type', 'user', 'alert']
        db.create_unique(u'alerts_useralertweightconfig', ['bluusite_id', 'device_type_id', 'user_id', 'alert_id'])

        # Deleting model 'UserAlertScaleConfig'
        db.delete_table(u'alerts_useralertscaleconfig')
    ...
    models = {
        ...
        u'alerts.alertrunner': {
            'Meta': {'object_name': 'AlertRunner'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'since': ('django.db.models.fields.DateTimeField', [], {}),
            'user_alert_device': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['alerts.UserAlertDevice']", 'null': 'True', 'blank': 'True'}),
            'user_alert_room': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['alerts.UserAlertRoom']", 'null': 'True', 'blank': 'True'}),
            'when': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'})
        },
        u'alerts.useralertconfig': {
            'Meta': {'unique_together': "((u'bluusite', u'device_type', u'user', u'alert'),)", 'object_name': 'UserAlertConfig'},
        ...
        u'alerts.useralertroom': {
            'Meta': {'unique_together': "((u'user', u'room', u'alert'),)", 'object_name': 'UserAlertRoom'},
            'alert': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['alerts.Alert']"}),
            'duration': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'email_notification': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'alerts.useralertscale': {
            'Meta': {'unique_together': "((u'user', u'device', u'alert'),)", 'object_name': 'UserAlertScale'},
            'alert': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['alerts.Alert']"}),
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Device']"}),
            'email_notification': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'alerts.useralertscaleconfig': {
            'Meta': {'unique_together': "((u'bluusite', u'device_type', u'user', u'alert'),)", 'object_name': 'UserAlertScaleConfig'},
            'alert': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['alerts.Alert']"}),
            'bluusite': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bluusites.BluuSite']"}),
            'device_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.DeviceType']"}),
            'email_notification': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
