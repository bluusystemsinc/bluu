...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserAlertScale'
        db.create_table(u'alerts_useralertscale', (
        ...
        db.send_create_signal(u'alerts', ['UserAlertScale'])

        # Adding unique constraint on 'UserAlertScale', fields ['user', 'device', 'alert']
        db.create_unique(u'alerts_useralertscale', ['user_id', 'device_id', 'alert_id'])

        # Adding model 'AlertRunner'
        db.create_table(u'alerts_alertrunner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('user_alert_device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alerts.UserAlertDevice'], null=True, blank=True)),
            ('user_alert_room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alerts.UserAlertRoom'], null=True, blank=True)),
            ('since', self.gf('django.db.models.fields.DateTimeField')()),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'alerts', ['AlertRunner'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserAlertScale', fields ['user', 'device', 'alert']
        db.delete_unique(u'alerts_useralertscale', ['user_id', 'device_id', 'alert_id'])

        # Deleting model 'UserAlertScale'
        db.delete_table(u'alerts_useralertscale')

        # Deleting model 'AlertRunner'
        db.delete_table(u'alerts_alertrunner')
    ...
    models = {
        ...
        u'alerts.useralertweightconfig': {
            'Meta': {'unique_together': "((u'bluusite', u'device_type', u'user', u'alert'),)", 'object_name': 'UserAlertWeightConfig'},
            'alert': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['alerts.Alert']"}),
            'bluusite': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bluusites.BluuSite']"}),
            'device_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.DeviceType']"}),
            'email_notification': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
