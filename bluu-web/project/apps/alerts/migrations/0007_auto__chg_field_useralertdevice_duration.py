...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAlertDevice.duration'
        db.alter_column(u'alerts_useralertdevice', 'duration', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserAlertDevice.duration'
        db.alter_column(u'alerts_useralertdevice', 'duration', self.gf('django.db.models.fields.IntegerField')(default=1))
