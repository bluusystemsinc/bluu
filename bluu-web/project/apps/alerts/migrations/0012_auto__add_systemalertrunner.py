...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SystemAlertRunner'
        db.create_table(u'alerts_systemalertrunner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Device'], null=True, blank=True)),
            ('bluusite', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bluusites.BluuSite'], null=True, blank=True)),
            ('alert', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alerts.Alert'], null=True, blank=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('period', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('since', self.gf('django.db.models.fields.DateTimeField')()),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'alerts', ['SystemAlertRunner'])


    def backwards(self, orm):
        # Deleting model 'SystemAlertRunner'
        db.delete_table(u'alerts_systemalertrunner')
    ...
    models = {
        ...
        u'alerts.systemalertrunner': {
            'Meta': {'object_name': 'SystemAlertRunner'},
            'alert': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['alerts.Alert']", 'null': 'True', 'blank': 'True'}),
            'bluusite': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bluusites.BluuSite']", 'null': 'True', 'blank': 'True'}),
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Device']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'period': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'since': ('django.db.models.fields.DateTimeField', [], {}),
            'when': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'})
        },
        ...
        u'bluusites.bluusite': {
            ...
            'dealer_alerts': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'user_alerts': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
