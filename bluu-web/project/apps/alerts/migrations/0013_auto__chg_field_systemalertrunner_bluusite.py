...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SystemAlertRunner.bluusite'
        db.alter_column(u'alerts_systemalertrunner', 'bluusite_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['bluusites.BluuSite']))

    def backwards(self, orm):

        # Changing field 'SystemAlertRunner.bluusite'
        db.alter_column(u'alerts_systemalertrunner', 'bluusite_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bluusites.BluuSite'], null=True))
