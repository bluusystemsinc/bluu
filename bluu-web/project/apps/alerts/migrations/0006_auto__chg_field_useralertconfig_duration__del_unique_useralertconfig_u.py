...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAlertConfig.duration'
        db.alter_column(u'alerts_useralertconfig', 'duration', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Adding unique constraint on 'UserAlertConfig', fields ['alert', 'bluusite', 'device_type', 'user']
        db.create_unique(u'alerts_useralertconfig', ['alert_id', 'bluusite_id', 'device_type_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserAlertConfig', fields ['alert', 'bluusite', 'device_type', 'user']
        db.delete_unique(u'alerts_useralertconfig', ['alert_id', 'bluusite_id', 'device_type_id', 'user_id'])


        # Changing field 'UserAlertConfig.duration'
        db.alter_column(u'alerts_useralertconfig', 'duration', self.gf('django.db.models.fields.IntegerField')(default=1))
