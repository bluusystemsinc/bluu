...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAlertConfig.bluusite'
        db.add_column(u'alerts_useralertconfig', 'bluusite',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['bluusites.BluuSite']),
                      keep_default=False)

        # Adding field 'UserAlertConfig.device_type'
        db.add_column(u'alerts_useralertconfig', 'device_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['devices.DeviceType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAlertConfig.bluusite'
        db.delete_column(u'alerts_useralertconfig', 'bluusite_id')

        # Deleting field 'UserAlertConfig.device_type'
        db.delete_column(u'alerts_useralertconfig', 'device_type_id')
