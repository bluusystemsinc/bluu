...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Status', fields ['timestamp']
        db.create_index(u'devices_status', ['timestamp'])


    def backwards(self, orm):
        # Removing index on 'Status', fields ['timestamp']
        db.delete_index(u'devices_status', ['timestamp'])
