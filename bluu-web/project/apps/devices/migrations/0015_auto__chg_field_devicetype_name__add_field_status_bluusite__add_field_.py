...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeviceType.name'
        db.alter_column(u'devices_devicetype', 'name', self.gf('django.db.models.fields.CharField')(max_length=15))
        # Adding field 'Status.bluusite'
        db.add_column(u'devices_status', 'bluusite',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bluusites.BluuSite'], null=True),
                      keep_default=False)

        # Adding field 'Status.device_type'
        db.add_column(u'devices_status', 'device_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.DeviceType'], null=True),
                      keep_default=False)

        # Adding field 'Status.room'
        db.add_column(u'devices_status', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bluusites.Room'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DeviceType.name'
        db.alter_column(u'devices_devicetype', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Deleting field 'Status.bluusite'
        db.delete_column(u'devices_status', 'bluusite_id')

        # Deleting field 'Status.device_type'
        db.delete_column(u'devices_status', 'device_type_id')

        # Deleting field 'Status.room'
        db.delete_column(u'devices_status', 'room_id')
    ...
    models = {
        ...
        u'devices.status': {
            ...
            'bluusite': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bluusites.BluuSite']", 'null': 'True'}),
            ...
            'device_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.DeviceType']", 'null': 'True'}),
            ...
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bluusites.Room']", 'null': 'True'}),
