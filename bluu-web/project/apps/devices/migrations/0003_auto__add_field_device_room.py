...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'devices_device', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['bluusites.Room']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.room'
        db.delete_column(u'devices_device', 'room_id')
