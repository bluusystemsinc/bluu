...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Device.slug'
        db.alter_column(u'devices_device', 'slug', self.gf('autoslug.fields.AutoSlugField')(default='2013-03-26', unique_with=(), max_length=50, populate_from=u'serial'))

    def backwards(self, orm):

        # Changing field 'Device.slug'
        db.alter_column(u'devices_device', 'slug', self.gf('autoslug.fields.AutoSlugField')(populate_from=u'serial', unique_with=(), max_length=50, null=True))
