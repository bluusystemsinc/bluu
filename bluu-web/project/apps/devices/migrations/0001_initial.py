...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'devices_device', (
            ...
            ('serial', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('device_type', self.gf('django.db.models.fields.CharField')(max_length=8)),
        ...
        # Adding model 'Status'
        db.create_table(u'devices_status', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('battery', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('input1', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('input2', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('input3', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('input4', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('supervisory', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tamper', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'devices', ['Status'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'devices_status')
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'device_type': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
