...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.slug'
        db.add_column(u'devices_device', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), null=True, populate_from=u'serial', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.slug'
        db.delete_column(u'devices_device', 'slug')
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '50', 'unique_with': '()', 'null': 'True', 'populate_from': "u'serial'", 'blank': 'True'})
        },
