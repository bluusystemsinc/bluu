...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for status in orm['devices.Status'].objects.all():
            status.device_type = status.device.device_type
            status.bluusite = status.device.bluusite
            status.room = status.device.room
            status.save()
